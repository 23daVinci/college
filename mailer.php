...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		$emp_id = $first_name.mt_rand(1000, 9999);
		$options = [
		    'cost' => 10,
		];
		...
		if($insert_result1 && $insert_result2 && $f_upload_result)
		{
			...
			$act_url = "192.168.202.178/fp/activation.php?eid=$emp_id&".$act_id;
			...
			$to = $email;
			$subject = "FCRIT : Account Verification";
         
			$message = "Dear <b>$first_name</b>, Please click on the link below to activate your account:<br><br><b><a href=$act_url><button>Click me</button></a><b>";
			//$message .= "Delete this message after you've read it.\n";
			//$message .= "Thanks for your time.";


         
			$header = "From:fcritfacultyinfo@gmail.com"."\r\n";
			...
			if(!$send_mail) {
			    echo 'We are facing an internal problem. Kindly check back later. If you are getting this error continuously, kindly report it to the Administrator. Thanks for your time.';
			    //echo 'Mailer Error: ' . $mail->ErrorInfo;
			} else {
			    echo 'A verification email has been sent. Please check your email. Thanks for your time. ';
